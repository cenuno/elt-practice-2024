{% macro union_acme_claim_by_tables_by_pattern(schema, pattern) %}
    ...
    {%- set relations = [
        "processed_acme_patient_claim_202307",
        "processed_acme_patient_claim_202308",
    ] -%}
    {# log("relations: " ~ relations, info=True) #}
    {%- for relation in relations %}
        select {{ get_client_acme_claim_processed_columns() }}, '{{ relation }}' as relation_name
